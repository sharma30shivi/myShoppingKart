...
VALUES ('Shivi', 'Sharma', 'ADMIN', true, 'admin', 'ss@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Harry', 'Dhani', 'SUPPLIER', true, '12345', 'hd@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Vanshu', 'Setia', 'SUPPLIER', true, '12345', 'vs@gmail.com', '7777777777');
